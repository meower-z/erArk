...
def handle_add_1_nclimax_experience(
    ...
    if character_data.dead:
        return
    base_chara_experience_common_settle(character_id, 10, 1, change_data=change_data, target_character_id=None)
    base_chara_experience_common_settle(character_id, 20, 1, change_data=change_data, target_character_id=None)
    if character_data.sp_flag.is_h == 1:
...
def handle_add_1_bclimax_experience(
    ...
    if character_data.dead:
        return
    base_chara_experience_common_settle(character_id, 11, 1, change_data=change_data, target_character_id=None)
    base_chara_experience_common_settle(character_id, 20, 1, change_data=change_data, target_character_id=None)
    if character_data.sp_flag.is_h == 1:
...
def handle_add_1_cclimax_experience(
    ...
    if character_data.dead:
        return
    base_chara_experience_common_settle(character_id, 12, 1, change_data=change_data, target_character_id=None)
    base_chara_experience_common_settle(character_id, 20, 1, change_data=change_data, target_character_id=None)
    if character_data.sp_flag.is_h == 1:
...
def handle_add_1_vclimax_experience(
    ...
    if character_data.dead:
        return
    base_chara_experience_common_settle(character_id, 14, 1, change_data=change_data, target_character_id=None)
    base_chara_experience_common_settle(character_id, 20, 1, change_data=change_data, target_character_id=None)
    if character_data.sp_flag.is_h == 1:
...
def handle_add_1_aclimax_experience(
    ...
    if character_data.dead:
        return
    base_chara_experience_common_settle(character_id, 15, 1, change_data=change_data, target_character_id=None)
    base_chara_experience_common_settle(character_id, 20, 1, change_data=change_data, target_character_id=None)
    if character_data.sp_flag.is_h == 1:
...
def handle_add_1_uclimax_experience(
    ...
    if character_data.dead:
        return
    base_chara_experience_common_settle(character_id, 16, 1, change_data=change_data, target_character_id=None)
    base_chara_experience_common_settle(character_id, 20, 1, change_data=change_data, target_character_id=None)
    if character_data.sp_flag.is_h == 1:
...
def handle_add_1_wclimax_experience(
    ...
    if character_data.dead:
        return
    base_chara_experience_common_settle(character_id, 17, 1, change_data=change_data, target_character_id=None)
    base_chara_experience_common_settle(character_id, 20, 1, change_data=change_data, target_character_id=None)
    if character_data.sp_flag.is_h == 1:
...
def handle_add_1_cumming_experience(
    ...
    if character_data.dead:
        return
    base_chara_experience_common_settle(character_id, 21, 1, change_data=change_data, target_character_id=None)
...
def handle_add_1_milking_experience(
    ...
    if character_data.dead:
        return
    base_chara_experience_common_settle(character_id, 22, 1, change_data=change_data, target_character_id=None)
...
def handle_add_1_peeing_experience(
    ...
    if character_data.dead:
        return
    base_chara_experience_common_settle(character_id, 23, 1, change_data=change_data, target_character_id=None)
...
def handle_target_add_1_cums_experience(
    ...
    if character_data.dead:
        return
    base_chara_experience_common_settle(character_data.target_character_id, 24, 1, target_flag=False, change_data=change_data, target_character_id=None)
...
def handle_down_small_hit_point(
    ...
    base_chara_hp_mp_common_settle(character_id, 10, -1, degree=0, change_data=change_data, target_character_id=None)
...
def handle_down_small_mana_point(
    ...
    base_chara_hp_mp_common_settle(character_id, 20, mp_value=-1, degree=0, change_data=change_data, target_character_id=None)
...
def handle_down_middle_hit_point(
    ...
    base_chara_hp_mp_common_settle(character_id, 20, -1, degree=1, change_data=change_data, target_character_id=None)
...
def handle_down_middle_mana_point(
    ...
    base_chara_hp_mp_common_settle(character_id, 25, mp_value=-1, degree=1, change_data=change_data, target_character_id=None)
...
def handle_down_large_hit_point(
    ...
    base_chara_hp_mp_common_settle(character_id, 30, -1, degree=2, change_data=change_data, target_character_id=None)
...
def handle_down_large_mana_point(
    ...
    base_chara_hp_mp_common_settle(character_id, 30, mp_value=-1, degree=2, change_data=change_data, target_character_id=None)
...
def handle_add_1_sex_v_experience(
    ...
    change_data -- 状态变更信息记录对象
    """
    base_chara_experience_common_settle(character_id, 61, 1, change_data=change_data, target_character_id=None)
...
def handle_add_1_sex_a_experience(
    ...
    change_data -- 状态变更信息记录对象
    """
    base_chara_experience_common_settle(character_id, 62, 1, change_data=change_data, target_character_id=None)
...
def handle_add_1_sex_u_experience(
    ...
    change_data -- 状态变更信息记录对象
    """
    base_chara_experience_common_settle(character_id, 63, 1, change_data=change_data, target_character_id=None)
...
def handle_add_1_sex_w_experience(
    ...
    change_data -- 状态变更信息记录对象
    """
    base_chara_experience_common_settle(character_id, 64, 1, change_data=change_data, target_character_id=None)
...
def handle_add_1_expand_v_experience(
    ...
    change_data -- 状态变更信息记录对象
    """
    base_chara_experience_common_settle(character_id, 65, 1, change_data=change_data, target_character_id=None)
...
def handle_add_1_expand_a_experience(
    ...
    change_data -- 状态变更信息记录对象
    """
    base_chara_experience_common_settle(character_id, 66, 1, change_data=change_data, target_character_id=None)
...
def handle_add_1_expand_u_experience(
    ...
    change_data -- 状态变更信息记录对象
    """
    base_chara_experience_common_settle(character_id, 67, 1, change_data=change_data, target_character_id=None)
...
def handle_add_1_expand_w_experience(
    ...
    change_data -- 状态变更信息记录对象
    """
    base_chara_experience_common_settle(character_id, 68, 1, change_data=change_data, target_character_id=None)
...
def handle_add_1_n_experience(
    ...
    change_data -- 状态变更信息记录对象
    """
    base_chara_experience_common_settle(character_id, 0, 1, change_data=change_data, target_character_id=None)
...
def handle_add_1_b_experience(
    ...
    change_data -- 状态变更信息记录对象
    """
    base_chara_experience_common_settle(character_id, 1, 1, change_data=change_data, target_character_id=None)
...
def handle_add_1_c_experience(
    ...
    change_data -- 状态变更信息记录对象
    """
    base_chara_experience_common_settle(character_id, 2, 1, change_data=change_data, target_character_id=None)
...
def handle_add_1_p_experience(
    ...
    change_data -- 状态变更信息记录对象
    """
    base_chara_experience_common_settle(character_id, 3, 1, change_data=change_data, target_character_id=None)
...
def handle_add_1_v_experience(
    ...
    change_data -- 状态变更信息记录对象
    """
    base_chara_experience_common_settle(character_id, 4, 1, change_data=change_data, target_character_id=None)
...
def handle_add_1_a_experience(
    ...
    change_data -- 状态变更信息记录对象
    """
    base_chara_experience_common_settle(character_id, 5, 1, change_data=change_data, target_character_id=None)
...
def handle_add_1_u_experience(
    ...
    change_data -- 状态变更信息记录对象
    """
    base_chara_experience_common_settle(character_id, 6, 1, change_data=change_data, target_character_id=None)
...
def handle_add_1_w_experience(
    ...
    change_data -- 状态变更信息记录对象
    """
    base_chara_experience_common_settle(character_id, 7, 1, change_data=change_data, target_character_id=None)
...
def handle_add_1_mclimax_experience(
    ...
    if character_data.dead:
        return
    base_chara_experience_common_settle(character_id, 156, 1, change_data=change_data, target_character_id=None)
    base_chara_experience_common_settle(character_id, 20, 1, change_data=change_data, target_character_id=None)
    if character_data.sp_flag.is_h == 1:
...
def handle_add_1_fclimax_experience(
    ...
    if character_data.dead:
        return
    base_chara_experience_common_settle(character_id, 157, 1, change_data=change_data, target_character_id=None)
    base_chara_experience_common_settle(character_id, 20, 1, change_data=change_data, target_character_id=None)
    if character_data.sp_flag.is_h == 1:
...
def handle_add_1_hclimax_experience(
    ...
    if character_data.dead:
        return
    base_chara_experience_common_settle(character_id, 158, 1, change_data=change_data, target_character_id=None)
    base_chara_experience_common_settle(character_id, 20, 1, change_data=change_data, target_character_id=None)
    if character_data.sp_flag.is_h == 1:
...
def handle_add_1_m_experience(
    ...
    change_data -- 状态变更信息记录对象
    """
    base_chara_experience_common_settle(character_id, 153, 1, change_data=change_data, target_character_id=None)
...
def handle_add_1_f_experience(
    ...
    change_data -- 状态变更信息记录对象
    """
    base_chara_experience_common_settle(character_id, 154, 1, change_data=change_data, target_character_id=None)
...
def handle_add_1_h_experience(
    ...
    change_data -- 状态变更信息记录对象
    """
    base_chara_experience_common_settle(character_id, 155, 1, change_data=change_data, target_character_id=None)
