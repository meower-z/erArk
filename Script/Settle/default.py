...
def handle_down_interaction_favoravility(
    ...
    if not add_time:
        return
    base_chara_favorability_and_trust_common_settle(character_id, add_time, True, 0, -1, change_data, target_character_id=target_character_id)
...
def handle_add_small_trust(
    ...
    if not add_time:
        return
    base_chara_favorability_and_trust_common_settle(character_id, add_time, False, 0, 0, change_data, target_character_id=target_character_id)
...
def handle_down_small_trust(
    ...
    if not add_time:
        return
    base_chara_favorability_and_trust_common_settle(character_id, add_time, False, 0, -1, change_data, target_character_id=target_character_id)
...
def handle_sub_both_small_hit_point(
    ...
    now_time -- 结算的时间
    """
    base_chara_hp_mp_common_settle(character_id, add_time, hp_value=-1, target_flag=True, change_data=change_data, target_character_id=target_character_id)
...
def handle_sub_both_small_mana_point(
    ...
    now_time -- 结算的时间
    """
    base_chara_hp_mp_common_settle(character_id, add_time, mp_value=-1, target_flag=True, change_data=change_data, target_character_id=target_character_id)
...
def handle_sub_both_medium_hit_point(
    ...
    now_time -- 结算的时间
    """
    base_chara_hp_mp_common_settle(character_id, add_time, hp_value=-1, degree=1, target_flag=True, change_data=change_data, target_character_id=target_character_id)
...
def handle_sub_both_medium_mana_point(
    ...
    now_time -- 结算的时间
    """
    base_chara_hp_mp_common_settle(character_id, add_time, mp_value=-1, degree=1, target_flag=True, change_data=change_data, target_character_id=target_character_id)
...
def handle_sub_both_large_hit_point(
    ...
    now_time -- 结算的时间
    """
    base_chara_hp_mp_common_settle(character_id, add_time, hp_value=-1, degree=2, target_flag=True, change_data=change_data, target_character_id=target_character_id)
...
def handle_sub_both_large_mana_point(
    ...
    now_time -- 结算的时间
    """
    base_chara_hp_mp_common_settle(character_id, add_time, mp_value=-1, degree=2, target_flag=True, change_data=change_data, target_character_id=target_character_id)
...
def handle_sub_self_small_hit_point(
    ...
    now_time -- 结算的时间
    """
    base_chara_hp_mp_common_settle(character_id, add_time, hp_value=-1, change_data=change_data, target_character_id=target_character_id)
...
def handle_sub_self_small_mana_point(
    ...
    now_time -- 结算的时间
    """
    base_chara_hp_mp_common_settle(character_id, add_time, mp_value=-1, change_data=change_data, target_character_id=target_character_id)
...
def handle_sub_self_medium_hit_point(
    ...
    now_time -- 结算的时间
    """
    base_chara_hp_mp_common_settle(character_id, add_time, hp_value=-1, degree=1, change_data=change_data, target_character_id=target_character_id)
...
def handle_sub_self_medium_mana_point(
    ...
    now_time -- 结算的时间
    """
    base_chara_hp_mp_common_settle(character_id, add_time, mp_value=-1, degree=1, change_data=change_data, target_character_id=target_character_id)
...
def handle_sub_self_large_hit_point(
    ...
    now_time -- 结算的时间
    """
    base_chara_hp_mp_common_settle(character_id, add_time, hp_value=-1, degree=2, change_data=change_data, target_character_id=target_character_id)
...
def handle_sub_self_large_mana_point(
    ...
    now_time -- 结算的时间
    """
    base_chara_hp_mp_common_settle(character_id, add_time, mp_value=-1, degree=2, change_data=change_data, target_character_id=target_character_id)
...
def handle_talk_add_adjust(
    ...
    if target_character_id != character_id and (
        ...
        # 好感度变化#
        base_chara_favorability_and_trust_common_settle(character_id, add_time, True, 0, adjust, change_data, target_character_id=target_character_id)
        # 好意变化#
...
def handle_coffee_add_adjust(
    ...
    if target_character_id != character_id and (
        ...
        base_chara_favorability_and_trust_common_settle(character_id, add_time, True, 0, adjust, change_data, target_character_id=target_character_id)
        # 信赖变化#
        base_chara_favorability_and_trust_common_settle(character_id, add_time, False, 0, adjust, change_data, target_character_id=target_character_id)
        # 好意变化#
...
def handle_make_food_add_adjust(
    ...
    base_chara_experience_common_settle(character_id, 83, base_value = cook_difficulty, change_data = change_data, target_character_id=target_character_id)
...
def handle_taste_wine_add_adjust(
    ...
    # 增加饮酒经验
    base_chara_experience_common_settle(character_id, 94, change_data=change_data, target_character_id=target_character_id)
...
def handle_cure_patient_add_just(
    ...
    if character_id == 0:
        ...
        for patient_id in rhodes_island.player_examined_patient_ids:
            ...
            # 根据检查次数计算医疗经验
            base_chara_experience_common_settle(character_id, 88, base_value = exam_count, change_data = change_data, target_character_id=target_character_id)
        # 清空本次被诊疗的病人列表
    ...
    # 根据病情等级获取额外习得和医疗经验
    base_chara_state_common_settle(character_id, add_time, 9, ability_level = character_data.ability[46], extra_adjust = (severity_level + 1) / 2,  change_data = change_data)
    base_chara_experience_common_settle(character_id, 88, base_value = severity_level, change_data = change_data, target_character_id=target_character_id)
...
def handle_masturebate_add_adjust(
    ...
    # 增加部位经验
    base_chara_experience_common_settle(character_id, part_id, 1, change_data = change_data, target_character_id=target_character_id)
    # 如果已持有玩家的阴茎倒模
    if handle_premise.handle_have_penis_mold(character_id):
        # 额外增加一次快感
        base_chara_state_common_settle(character_id, add_time, part_id, 50, ability_level = character_data.ability[30], change_data = change_data)
        # 增加1道具使用经验
        base_chara_experience_common_settle(character_id, 51, 1, change_data = change_data, target_character_id=target_character_id)
        # 增加对玩家好感
...
def handle_give_gift_add_adjust(
    ...
    if gift_data.type == 3:
        ...
        if gift_data.item_id == 172:
            base_chara_favorability_and_trust_common_settle(character_id, 10, True, 0, talk_adjust * 1.5, change_data, target_character_id=target_character_id)
        ...
        # 好感礼物中
            ...
            base_chara_favorability_and_trust_common_settle(character_id, 30, True, 0, talk_adjust * 2, change_data, target_character_id=target_character_id)
            base_chara_favorability_and_trust_common_settle(character_id, 10, False, 0, talk_adjust * 2, change_data, target_character_id=target_character_id)
    ...
    # 道歉礼物
        ...
        # 其他数据结算
        base_chara_favorability_and_trust_common_settle(character_id, 10, True, 0, 0, change_data, target_character_id=target_character_id)
        base_chara_state_common_settle(target_character_id, 10, 11, ability_level = target_data.ability[32], change_data_to_target_change = change_data)
    ...
    # 阴茎倒模
        ...
        # 增加好感与羞耻
        base_chara_favorability_and_trust_common_settle(character_id, 100, True, change_data = change_data, target_character_id=target_character_id)
...
def handle_read_add_adjust(
    ...
    for experience_index in experience_index_list:
        base_chara_experience_common_settle(character_id, experience_index, 1, change_data = change_data, target_character_id=target_character_id)
        # 如果有交互对象，则交互对象也加
        if target_character_id != character_id:
            base_chara_experience_common_settle(character_id, experience_index, 1, target_flag = True, change_data = change_data, target_character_id=target_character_id)
        ...
        if character_data.entertainment.read_book_progress[book_id] >= 100 or cache.debug_mode:
            ...
            if exp_id != 0:
                if book_difficulty == 1:
                    ...
                    add_value = 40
                base_chara_experience_common_settle(character_id, exp_id, add_value, change_data = change_data, target_character_id=target_character_id)
            # 结算习得
...
def handle_teach_add_just(
    ...
    base_chara_experience_common_settle(character_id, 82, target_character_id=target_character_id)
...
def handle_high_obscenity_failed_adjust(
    ...
    if target_character_id:
        ...
        target_data.sp_flag.angry_with_player = True
        # 降好感
        base_chara_favorability_and_trust_common_settle(character_id, add_time, True, 0, -3, change_data, target_character_id=target_character_id)
        # 降信赖
