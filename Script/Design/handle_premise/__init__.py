...
def handle_instruct_judge_low_obscenity(character_id: int) -> int:
    ...
    if character_id == 0:
        return 0
    if instuct_judege.calculation_instuct_judege(0, character_id, _("初级骚扰"), not_draw_flag=True, settle_hypnosis=False)[0]:
        return 1
    return 0
...
def handle_target_instruct_judge_low_obscenity(character_id: int) -> int:
    ...
    if instuct_judege.calculation_instuct_judege(character_id, target_character_id, _("初级骚扰"), not_draw_flag=True, settle_hypnosis=False)[0]:
        return 1
    return 0
...
def handle_instruct_judge_high_obscenity(character_id: int) -> int:
    ...
    if character_id == 0:
        return 0
    if instuct_judege.calculation_instuct_judege(0, character_id, _("严重骚扰"), not_draw_flag=True, settle_hypnosis=False)[0]:
        return 1
    return 0
...
def handle_target_instruct_judge_high_obscenity(character_id: int) -> int:
    ...
    if instuct_judege.calculation_instuct_judege(character_id, target_character_id, _("严重骚扰"), not_draw_flag=True, settle_hypnosis=False)[0]:
        return 1
    return 0
...
def handle_instruct_judge_h(character_id: int) -> int:
    ...
    if character_id == 0:
        return 0
    if instuct_judege.calculation_instuct_judege(0, character_id, _("H模式"), not_draw_flag=True, settle_hypnosis=False)[0]:
        return 1
    return 0
...
def handle_target_instruct_judge_h(character_id: int) -> int:
    ...
    if character_id == target_character_id:
        return 0
    if instuct_judege.calculation_instuct_judege(character_id, target_character_id, _("H模式"), not_draw_flag=True, settle_hypnosis=False)[0]:
        return 1
    return 0
...
def handle_instruct_judge_group_sex(character_id: int) -> int:
    ...
    if character_id == 0:
        return 0
    if instuct_judege.calculation_instuct_judege(0, character_id, _("群交"), not_draw_flag=True, settle_hypnosis=False)[0]:
        return 1
    return 0
