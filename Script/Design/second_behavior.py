        ...
        if behavior_data != 0:
            ...
            for effect_id in game_config.config_behavior_effect_data[second_behavior_id]:
                ...
                if isinstance(effect_id, str) and "CVE" in effect_id:
                    ...
                    settle_behavior.handle_comprehensive_value_effect(character_id, effect_all_value_list, change_data, target_character_id="CURRENT_TARGET")
                else:
...
def insert_position_effect(character_id: int, change_data: game_type.CharacterStatusChange):
    ...
    if (
        ...
        if pl_character_data.h_state.current_sex_position != -1:
            ...
            base_chara_experience_common_settle(character_id, exp_id, change_data = change_data, target_character_id="CURRENT_TARGET")
            # 玩家增加对应姿势的经验
            base_chara_experience_common_settle(0, exp_id, change_data_to_target_change = change_data, target_character_id="CURRENT_TARGET")
